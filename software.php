...
<body>
  ...
  <div class="main">
    ...
    <h1 class="text-center display-1">Lernen Sie unser Softwareteam kennen</h1>

    <div class="flow">
      <h3 class="text-center">Unser Softwareteam <br> Ihr Partner für digitale Innovation, <br> maßgeschneiderte Lösungen und Effizienzsteigerung.</h3>
    ...
    <p class="text-center lead">Uns treibt die Idee an, dass die beste Arbeit aus Fleiß, <br> Entwicklungskunst und Spaß entsteht. </p>
  </div>
